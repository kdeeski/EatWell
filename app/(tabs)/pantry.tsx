...
const styles = StyleSheet.create({
  ...
  swipeBgLeft: { right: 0, backgroundColor: colors.state.danger },
  swipeBgText: { color: colors.text.inverse, fontWeight: '700', fontSize: 13 },

  itemRow: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: colors.background.surface, borderRadius: 10,
    paddingHorizontal: 14, paddingVertical: 12,
    borderWidth: 1, borderColor: colors.border.default,
  },
  itemRowLowStock: { borderLeftWidth: 3, borderLeftColor: colors.rating.star },
  itemLeft: { flex: 1 },
  itemName: { fontSize: 15, color: colors.text.primary, fontWeight: '500', textTransform: 'capitalize' },
  itemMeta: { fontSize: 12, color: colors.text.placeholder, marginTop: 2 },
  lowStockText: { color: colors.rating.star, fontWeight: '600' },
  locationBadge: { backgroundColor: colors.background.elevated, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8, marginLeft: 8 },
  ...
  stapleLabel: { fontSize: 15, fontWeight: '600', color: colors.text.primary },
  stapleHint: { fontSize: 12, color: colors.text.placeholder, marginTop: 2 },
  stapleToggle: {
    width: 44, height: 26, borderRadius: 13, backgroundColor: colors.border.default,
    justifyContent: 'center', paddingHorizontal: 2,
  },
  stapleToggleOn: { backgroundColor: colors.brand.primary },
  stapleThumb: { width: 22, height: 22, borderRadius: 11, backgroundColor: colors.background.surface },
  ...
  categoriseButton: { backgroundColor: colors.brand.primary, borderRadius: 14, paddingVertical: 16, alignItems: 'center', marginTop: 16 },
  categoriseButtonText: { color: colors.text.inverse, fontSize: 16, fontWeight: '700' },
  analysingStep: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 16 },
  analysingText: { fontSize: 16, color: colors.text.muted },
  ...
  pendingNameInput: { fontSize: 15, color: colors.text.primary, borderBottomWidth: 1, borderBottomColor: colors.border.default, paddingBottom: 8, marginBottom: 8 },
  ...
  addManualButton: { borderWidth: 1, borderColor: colors.border.default, borderStyle: 'dashed', borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginBottom: 16 },
  addManualText: { fontSize: 15, color: colors.text.muted, fontWeight: '500' },
  saveRow: { padding: 16, backgroundColor: colors.background.surface, borderTopWidth: 1, borderTopColor: colors.border.hairline },
  saveButton: { backgroundColor: colors.brand.primary, borderRadius: 14, paddingVertical: 16, alignItems: 'center' },
  saveButtonText: { color: colors.text.inverse, fontSize: 16, fontWeight: '700' },
});
